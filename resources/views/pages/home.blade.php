...
@section('content')
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; {{ date('Y') }} Noteww</strong> using AdminLTE theme | <a
                href="https://github.com/Matiww/Noteww" target="_blank"><i class="fa fa-github" aria-hidden="true"></i>
            Github</a>
    </footer>
@endsection